  ...
  return (
    <>
      ...
      <div className='bg-white'>
        <Meta
          meta={{
            title: 'CloudNatix | Cost Reduction',
            description:
        ...
        <div className='mx-auto max-w-6xl py-12 sm:py-20 sm:px-2 lg:px-4'>
          <div className='mx-auto max-w-2xl px-4 lg:max-w-none'>
            ...
            <div className='mt-12 md:mt-24'>
              ...
              <p className='mt-2 text-base text-gray-500'>
                Capacity optimization that ensures your cloud and datacenter
                spend remains optimized, reducing idle capacity and resulting
                wasted cloud spend.
              </p>
              <ul className='list-disc ml-5 md:ml-10 mt-3 text-gray-500 space-y-3'>
                <li>
                  Cloud Cost reduction for companies where cloud costs have
                  become unmanageable, CloudNatix can help you realize immediat
                  cost reduction, provide holistic cost visibility and
                  attribution and finally maintain your optimized cost structure
                </li>
                <li>
